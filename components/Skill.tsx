...
export default function Skill({skill,directionLeft}: Props) {
    return <div className={"group relative flex cursor-pointer"}>
        ...
        />
        <div
            className={"absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white w-16 h-16 md:w-20 md:h-20 xl:w-24 xl:h-24 rounded-full z-0"}>
            <div className={"flex items-center justify-center h-full"}>
                <p className={"text-xl font-bold text-black opacity-100 md:text-2xl"}>{skill.progress}%</p>
            </div>
        </div>
    </div>
}